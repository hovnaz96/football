                ...
                <div class="isotope-item col-ml-12 col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-2">
                    <div class="be-post style-5">
                        ...
                        <div class="be-rowline">
                            ...
                            <div class="rowline-text">Leigh Taylor <span class="rowline-icon"><i
                                            class="fa fa-comment-o"></i></span></div>
                        </div>
                        <div class="be-rowline">
                            <img class="rowline-img" src="img/line_3.jpg" alt="">
                            <div class="rowline-text">Phoenix, the Creative Studio <span class="rowline-icon"><i
                ...
                <div class="isotope-item col-ml-12 col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-2">
                    <div class="be-post style-5">
                        ...
                        <div class="be-rowline">
                            ...
                            <div class="rowline-text">Louis Paquet <span class="rowline-icon"><i
                                            class="fa fa-thumbs-o-up"></i></span></div>
                        </div>
                        <div class="be-rowline">
